  ...
  return (
    <div className='navbar'>
      ...
      <ul className="navbar-menu">
        ...
        <a href="#add-download"><li onClick={()=>{setMenu("mobile-app")}} className={menu == "mobile-app" ? "active" : ""}>mobile-app</li></a>
        <a href="#footer"><li onClick={()=>{setMenu("contact-us")}} className={menu == "contact-us" ? "active" : ""}>contact-us</li></a>
        <Link to="/bot"><li onClick={()=>{setMenu("bot")}} className={menu == "bot" ? "active" : ""}>🤖</li></Link>
      </ul>
